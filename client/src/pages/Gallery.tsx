...
export default function Gallery() {
  const photos = [
    ...
    // TODO: Add more photos from extra-curricular activities
    // You can add photos by placing them in attached_assets/ and importing them:
    // import photo1 from '@assets/your-photo.png';
  ];
